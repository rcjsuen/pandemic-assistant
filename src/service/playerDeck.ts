export class PlayerDeck {
    ...
    constructor(initialDeckSize: number, private playerCount: number, eventCards: number, epidemicCards: number, modifier: number) {
        let total = initialDeckSize + eventCards + epidemicCards + modifier;
